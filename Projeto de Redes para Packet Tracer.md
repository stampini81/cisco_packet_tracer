...
2.  [Estrutura da Empresa e Requisitos](#2-estrutura-da-empresa-e-requisitos)
    * [Departamentos e Localização](#departamentos-e-localização)
    * [Contagem de PCs por Setor](#contagem-de-pcs-por-setor)
    * [Infraestrutura Física Necessária](#infraestrutura-física-necessária)
3.  [Planejamento da Infraestrutura Lógica](#3-planejamento-da-infraestrutura-lógica)
    * [Distribuição de Setores por VLANs](#distribuição-de-setores-por-vlans)
    * [Esquema de Endereçamento IP (com CIDR)](#esquema-de-endereçamento-ip-com-cidr)
    * [Endereçamento IP de Gerenciamento de Roteadores Wireless](#endereçamento-ip-de-gerenciamento-de-roteadores-wireless)
    * [Endereçamento IP de Pool DHCP para Notebooks](#endereçamento-ip-de-pool-dhcp-para-notebooks)
4.  [Guia de Implementação no Cisco Packet Tracer](#4-guia-de-implementação-no-cisco-packet-tracer)
    * [Ferramentas e Cabos](#ferramentas-e-cabos)
    * [Passo a Passo da Configuração](#passo-a-passo-da-configuração)
        1.  [Início e Representação dos Prédios](#1-início-e-representação-dos-prédios)
        2.  [Adicionando PCs e Servidores](#2-adicionando-pcs-e-servidores)
        3.  [Adicionando Switches e Roteadores Wireless](#3-adicionando-switches-e-roteadores-wireless)
        4.  [Conectando PCs e Servidores aos Switches](#4-conectando-pcs-e-servidores-aos-switches)
        5.  [Conectando Switches de Departamento aos Roteadores Wireless](#5-conectando-switches-de-departamento-aos-roteadores-wireless)
        6.  [Adicionando e Conectando Laptops Wireless](#6-adicionando-e-conectando-laptops-wireless)
        7.  [Substituindo e Configurando o Switch Central DTI (Camada 3)](#7-substituindo-e-configurando-o-switch-central-dti-camada-3)
        8.  [Criando VLANs em Todos os Switches](#8-criando-vlans-em-todos-os-switches)
        9.  [Configurando Portas de Acesso (Access Ports)](#9-configurando-portas-de-acesso-access-ports)
        10. [Configurando Portas Trunk em Todos os Switches](#10-configurando-portas-trunk-em-todos-os-switches)
        11. [Configurando Endereços IP Fixos em PCs e Servidores](#11-configurando-endereços-ip-fixos-em-pcs-e-servidores)
        12. [Configurando Roteadores Wireless (APs com DHCP para Notebooks)](#12-configurando-roteadores-wireless-aps-com-dhcp-para-notebooks)
        13. [Configurando Servidores DNS e HTTP](#13-configurando-servidores-dns-e-http)
5.  [Testes de Conectividade](#5-testes-de-conectividade)
